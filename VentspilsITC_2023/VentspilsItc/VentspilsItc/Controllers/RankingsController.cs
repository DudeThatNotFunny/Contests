...
namespace VentspilsItc.Controllers
{
    public class RankingsController : Controller
    {
        ...
        {
              return View(_context.Ranking.OrderByDescending(p => p.Score).Take(4).ToList());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Score,ScoreId")] Ranking ranking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Score,ScoreId")] Ranking ranking)
        {
            if (id != ranking.Id)
            {
                return NotFound();
